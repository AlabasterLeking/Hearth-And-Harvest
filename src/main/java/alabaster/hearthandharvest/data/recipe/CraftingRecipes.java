...
public class CraftingRecipes
{
    ...
    private static void recipesMaterials(RecipeOutput output) {
        unpack(output, RecipeCategory.FOOD, HHModItems.RASPBERRY.get(), HHModItems.RASPBERRY_CRATE.get(), "raspberry_from_crate");
        unpack(output, RecipeCategory.FOOD, HHModItems.BLUEBERRIES.get(), HHModItems.BLUEBERRY_CRATE.get(), "blueberries_from_crate");
        unpack(output, RecipeCategory.FOOD, HHModItems.CHERRY.get(), HHModItems.CHERRY_CRATE.get(), "cherry_from_crate");
        unpack(output, RecipeCategory.FOOD, HHModItems.RED_GRAPES.get(), HHModItems.RED_GRAPE_CRATE.get(), "red_grape_from_crate");
        unpack(output, RecipeCategory.FOOD, HHModItems.GREEN_GRAPES.get(), HHModItems.GREEN_GRAPE_CRATE.get(), "green_grape_from_crate");
        unpack(output, RecipeCategory.FOOD, HHModItems.PEANUT.get(), HHModItems.PEANUT_CRATE.get(), "peanut_from_crate");
        unpack(output, RecipeCategory.FOOD, HHModItems.CORN.get(), HHModItems.CORN_CRATE.get(), "corn_from_crate");
        ...
        unpack(output, RecipeCategory.MISC, HHModItems.COTTON.get(), HHModItems.COTTON_BALE.get(), "cotton_from_bale");
    ...
    private static void recipesFoodstuffs(RecipeOutput output) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.BLUEBERRY_PIE.get(), 1)
                ...
                .unlockedBy("has_blueberries", InventoryChangeTrigger.TriggerInstance.hasItems(HHModItems.BLUEBERRIES.get()))
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.CHERRY_PIE.get(), 1)
                .pattern("WWW")
                .pattern("FFF")
                .pattern("SPS")
                .define('W', Items.WHEAT)
                .define('S', Items.SUGAR)
                .define('F', HHCommonTags.FRUITS_CHERRY)
                .define('P', ModItems.PIE_CRUST.get())
                .unlockedBy("has_cherries", InventoryChangeTrigger.TriggerInstance.hasItems(HHModItems.CHERRY.get()))
                .save(output);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.CHERRY_PIE.get(), 1)
                .pattern("##")
                .pattern("##")
                .define('#', HHModItems.CHERRY_PIE_SLICE.get())
                .unlockedBy("has_cherry_pie_slice", InventoryChangeTrigger.TriggerInstance.hasItems(HHModItems.CHERRY_PIE_SLICE.get()))
                .group("cherry_pie")
                .save(output, ResourceLocation.fromNamespaceAndPath(HearthAndHarvest.MODID, "cherry_pie_from_slices"));
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.GRAPE_PIE.get(), 1)
                .pattern("##")
                .pattern("##")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.PIZZA.get(), 1)
                .pattern("SVM")
                .pattern("CCC")
                .pattern("DTD")
                ...
                .unlockedBy("has_wheat_dough", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WHEAT_DOUGH.get()))
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.PIZZA.get(), 1)
                .pattern("SVM")
                .pattern(" C ")
                ...
                .define('V', Tags.Items.FOODS_VEGETABLE)
                .define('M', Tags.Items.MUSHROOMS)
                .define('C', HHModItems.CHEESE_PIZZA.get())
                .unlockedBy("has_cheese_pizza", InventoryChangeTrigger.TriggerInstance.hasItems(HHModItems.CHEESE_PIZZA.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(HearthAndHarvest.MODID, "pizza_from_cheese_pizza"));
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.PIZZA.get(), 1)
                .pattern("##")
                .pattern("##")
                .define('#', HHModItems.PIZZA_SLICE.get())
                .unlockedBy("has_pizza_slice", InventoryChangeTrigger.TriggerInstance.hasItems(HHModItems.PIZZA_SLICE.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(HearthAndHarvest.MODID, "pizza_from_slices"));

        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.MEAT_PIZZA.get(), 1)
                .pattern("MMM")
                .pattern("CCC")
                .pattern("DTD")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.MEAT_PIZZA.get(), 1)
                ...
                .define('C', HHModItems.CHEESE_PIZZA.get())
                .unlockedBy("has_cheese_pizza", InventoryChangeTrigger.TriggerInstance.hasItems(HHModItems.CHEESE_PIZZA.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(HearthAndHarvest.MODID, "meat_pizza_from_cheese_pizza"));
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.MEAT_PIZZA.get(), 1)
                .pattern("##")
                .pattern("##")
                .define('#', HHModItems.MEAT_PIZZA_SLICE.get())
                .unlockedBy("has_meat_pizza_slice", InventoryChangeTrigger.TriggerInstance.hasItems(HHModItems.MEAT_PIZZA_SLICE.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(HearthAndHarvest.MODID, "meat_pizza_from_slices"));

        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.VEGGIE_PIZZA.get(), 1)
                .pattern("VMV")
                .pattern("CCC")
                .pattern("DTD")
                .define('V', Tags.Items.FOODS_VEGETABLE)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.VEGGIE_PIZZA.get(), 1)
                ...
                .define('C', HHModItems.CHEESE_PIZZA.get())
                .unlockedBy("has_cheese_pizza", InventoryChangeTrigger.TriggerInstance.hasItems(HHModItems.CHEESE_PIZZA.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(HearthAndHarvest.MODID, "veggie_pizza_from_cheese_pizza"));
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.VEGGIE_PIZZA.get(), 1)
                .pattern("##")
                .pattern("##")
                .define('#', HHModItems.VEGGIE_PIZZA_SLICE.get())
                .unlockedBy("has_veggie_pizza_slice", InventoryChangeTrigger.TriggerInstance.hasItems(HHModItems.VEGGIE_PIZZA_SLICE.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(HearthAndHarvest.MODID, "veggie_pizza_from_slices"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, HHModItems.CHEESE_PIZZA.get(), 1)
                .pattern("##")
                .pattern("##")
                .define('#', HHModItems.CHEESE_PIZZA_SLICE.get())
                .unlockedBy("has_cheese_pizza_slice", InventoryChangeTrigger.TriggerInstance.hasItems(HHModItems.CHEESE_PIZZA_SLICE.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(HearthAndHarvest.MODID, "cheese_pizza_from_slices"));
